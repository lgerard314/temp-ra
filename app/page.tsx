...
const colorTokens: { key: string; token: string; value: string; classes?: string[]; uses: ColorUse[]; when: string }[] = [
  ...
  { key: "fg-strong",   token: "--gd-color-fg-strong",   value: "#0c1117",
    classes: [".gd-banner", ".gd-bar--dark", ".gd-btn--ghost", ".gd-card__title", ".gd-display", ".gd-filebar__value", ".gd-frame", ".gd-h1", ".gd-h2", ".gd-h2-display", ".gd-h3", ".gd-h4", ".gd-label", ".gd-ledger__label", ".gd-ledger__money", ".gd-phone", ".gd-pm__name", ".gd-pullquote", ".gd-serif", ".gd-slider", ".gd-slider__layer--before", ".gd-slider__meta", ".gd-status--active", ".gd-surface--dark", ".gd-topnav__link", ".gd-trust__value", ".gd-warranty__text", ".gd-weather__temp"],
  ...
  { key: "fg",          token: "--gd-color-fg",          value: "#1d242d",
    classes: [".gd-body", ".gd-body-l", ".gd-body-s", ".gd-card__body", ".gd-chip", ".gd-input", ".gd-ledger__meta", ".gd-list", ".gd-select", ".gd-textarea"],
    uses: ["typography"],
    when: "Typography — body text." },
  { key: "fg-muted",    token: "--gd-color-fg-muted",    value: "#5a6168",
    classes: [".gd-banner__meta", ".gd-caption", ".gd-filebar__label", ".gd-ledger__num", ".gd-ledger__row--header", ".gd-mono", ".gd-mono-s", ".gd-pm__meta", ".gd-pm__title", ".gd-quote__cite", ".gd-slider__layer--after", ".gd-status", ".gd-status--filed", ".gd-trust__label", ".gd-weather", ".gd-weather__label"],
...
const typeRoles: {
  ...
  { className: "gd-mono-s",    sample: "STATUS · 240924 · OPEN", tokens: ["--gd-font-mono", "--gd-fs-mono-s", "--gd-fw-bold", "--gd-lh-body", "--gd-tr-mono-s", "--gd-fg-muted"],
